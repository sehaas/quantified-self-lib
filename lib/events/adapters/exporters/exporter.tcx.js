...
var EventExporterTCX = /** @class */ (function () {
    ...
    EventExporterTCX.getAsString = function (event) {
        return new Promise(function (resolve, reject) {
            ...
            var _loop_1 = function (activity) {
                ...
                var activityLaps = activity.getLaps().filter(function (lap) { return lap.type === lap_types_1.LapTypes.AutoLap; });
    ...
    EventExporterTCX.fileType = 'application/tcx';
    EventExporterTCX.fileExtension = 'tcx';
