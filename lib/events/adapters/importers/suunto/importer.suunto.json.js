...
var EventImporterSuuntoJSON = /** @class */ (function () {
    ...
    EventImporterSuuntoJSON.getPointFromSample = function (sample) {
        ...
        if (event_utilities_1.isNumberOrString(sample.Distance)) {
            point.addData(new data_distance_1.DataDistance(sample.Distance));
        }
        ...
        if (event_utilities_1.isNumberOrString(sample.BatteryCharge)) {
            point.addData(new data_battery_charge_1.DataBatteryCharge(sample.BatteryCharge * 100));
        }
        if (event_utilities_1.isNumberOrString(sample.BatteryCurrent)) {
            point.addData(new data_battery_current_1.DataBatteryCurrent(sample.BatteryCurrent));
        }
        if (event_utilities_1.isNumberOrString(sample.BatteryVoltage)) {
            point.addData(new data_battery_voltage_1.DataBatteryVoltage(sample.BatteryVoltage));
        }
        return point;
    };
