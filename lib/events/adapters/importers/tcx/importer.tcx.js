...
var EventImporterTCX = /** @class */ (function () {
    ...
    EventImporterTCX.getPoints = function (trackPointsElements) {
        return Array.from(trackPointsElements).reduce(function (pointsArray, trackPointElement) {
            ...
            for (var _i = 0, _a = trackPointElement.childNodes; _i < _a.length; _i++) {
                ...
                switch (dataElement.tagName) {
                    ...
                    case 'DistanceMeters': {
                        point.addData(new data_distance_1.DataDistance(Number(dataElement.textContent)));
                        break;
                    }
                    case 'AltitudeMeters': {
                    ...
                    case 'Extensions': {
                        for (var _b = 0, _c = dataElement.getElementsByTagNameNS('http://www.garmin.com/xmlschemas/ActivityExtension/v2', 'TPX')[0].childNodes; _b < _c.length; _b++) {
